function las2json(onelas){
	...
	function splitLineofType1(ver_info_obj,arrayString){
		...
		// console.log("0 unit_and_data = ",unit_and_data);
		...
		console.log("1 unit_and_data_str = ",unit_and_data_str);
		...
		ver_info_obj["DATA"] = data
  		...
  		// console.log("ver_info_obj['UNIT'] = ",ver_info_obj["UNIT"]);
  		//// 
	...
	console.log("0 param_line_array =",param_line_array)
	...
	console.log("0 curve_line_array =",curve_line_array)
	...
	console.log("0 curve_line_array =",well_line_array)
	...
	if(curve_str_array[0][0] === "A"){
		// curve_str_array[0].remove("  "," ").replace("   ","")
		...
		console.log("0 curve_names_array_holder = ",curve_names_array_holder)
		console.log("1 curve_names_array = ",curve_names_array)
		console.log("2 lasjson['CURVES'] = ",lasjson["CURVES"])
	}
	...
	for(j = 1; j < curve_str_array.length-1; j++){
		...
		// console.log("3 curve_data_line_array[j] = ",curve_data_line_array)
		var counter_of_curve_names = 0;
		for(k = 0; k < curve_data_line_array.length; k++){
			if(curve_data_line_array[k] !== ""){
				// console.log("4 curve_data_line_array[k] = ",curve_data_line_array[k]);
				// console.log("5a counter_of_curve_names = ",counter_of_curve_names)
				// console.log("curve_names_array_holder = ",curve_names_array_holder)
				// console.log("lasjson['CURVES'] = ",lasjson["CURVES"])
				// console.log("lasjson['CURVES'][curve_names_array_holder[counter_of_curve_names]] = ",lasjson["CURVES"][curve_names_array_holder[counter_of_curve_names]])
				// console.log("curve_data_line_array[k] = ",curve_data_line_array[k], " and k = ",k)
				// console.log("curve_names_array_holder[counter_of_curve_names] = ",curve_names_array_holder[counter_of_curve_names])
				// console.log("lasjson['CURVES'][curve_names_array_holder[counter_of_curve_names]] = ",lasjson["CURVES"][curve_names_array_holder[counter_of_curve_names]])
				// //lasjson["CURVES"][curve_names_array_holder[counter_of_curve_names]] = 
				
				lasjson["CURVES"][curve_names_array_holder[counter_of_curve_names]].push(curve_data_line_array[k])
				counter_of_curve_names += 1;
				// console.log("5b counter_of_curve_names = ",counter_of_curve_names)
			}
		}
	}
